from backend.schedulers.scheduler import OnlineScheduler
from typing import List, Dict, Optional
from backend.models import Action, FeasibleAction
...
class GreedyScheduler(OnlineScheduler):
    ...
    def choose(self, factory_state: FactoryState) -> Dict[str, Optional[Action]]:
        ...
        print(f"DEBUG: Feasible machine actions: {'\n'.join([f'Machine {machine_id}: {actions}' for machine_id, actions in feasible_machine_actions.items()])}")
